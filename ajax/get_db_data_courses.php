<?php
    ...
    $courses = [
        ...
        "students" => [
            ["firstName" => "Leon", "lastName" => "Wagner", "profession" => "FIAE", "status" => "green"],
            ["firstName" => "Emma", "lastName" => "Koch", "profession" => "FISI", "status" => "green"],
            ...
            ["firstName" => "Simon", "lastName" => "Frank", "profession" => "FIDM", "status" => "yellow"],
            ["firstName" => "Julia", "lastName" => "Krause", "profession" => "FIAE", "status" => "green"],
